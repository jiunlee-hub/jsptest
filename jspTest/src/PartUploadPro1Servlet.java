...
public class PartUploadPro1Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String uploadFileName = uploadFileName(contentDisposition);
		part.write(uploadFileName);
		out.println("작성자," + writer + "님이" + uploadFileName + "파일을 업도르 하였습니다.");
	}

	private String uploadFileName(String contentDisposition) {
